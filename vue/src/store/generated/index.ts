...
import UsernameHelloUsernameHelloHello from './username/hello/username.hello.hello'
...
export default { 
  ...
  UsernameHelloUsernameHelloHello: load(UsernameHelloUsernameHelloHello, 'username.hello.hello'),
