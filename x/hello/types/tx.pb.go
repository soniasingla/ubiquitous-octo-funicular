...
func init() {
	proto.RegisterType((*MsgCreatePost)(nil), "username.hello.hello.MsgCreatePost")
	proto.RegisterType((*MsgCreatePostResponse)(nil), "username.hello.hello.MsgCreatePostResponse")
}
...
var fileDescriptor_d7381608776cd4ef = []byte{
	...
	0xc9, 0xd7, 0x2f, 0xa9, 0xd0, 0x2b, 0x28, 0xca, 0x2f, 0xc9, 0x17, 0x12, 0x29, 0x2d, 0x4e, 0x2d,
	0xca, 0x4b, 0xcc, 0x4d, 0xd5, 0x03, 0x4b, 0x40, 0x48, 0xa5, 0x60, 0x2e, 0x5e, 0xdf, 0xe2, 0x74,
	...
	0x4c, 0x99, 0x29, 0x46, 0xa9, 0x5c, 0xcc, 0xbe, 0xc5, 0xe9, 0x42, 0x71, 0x5c, 0x5c, 0x48, 0x2e,
	0x50, 0xd6, 0xc3, 0xe6, 0x52, 0x3d, 0x14, 0x13, 0xa5, 0xb4, 0x89, 0x50, 0x04, 0xb3, 0xd6, 0xc9,
	...
	0x4a, 0x93, 0xf4, 0x92, 0xf3, 0x73, 0xf5, 0x61, 0x06, 0xea, 0x43, 0x02, 0xae, 0x02, 0x4a, 0x97,
	0x54, 0x16, 0xa4, 0x16, 0x27, 0xb1, 0x81, 0x03, 0xd1, 0x18, 0x10, 0x00, 0x00, 0xff, 0xff, 0x82,
	0x9e, 0x28, 0x95, 0x56, 0x01, 0x00, 0x00,
}
...
func (c *msgClient) CreatePost(ctx context.Context, in *MsgCreatePost, opts ...grpc.CallOption) (*MsgCreatePostResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/username.hello.hello.Msg/CreatePost", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_CreatePost_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/username.hello.hello.Msg/CreatePost",
	}
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "username.hello.hello.Msg",
